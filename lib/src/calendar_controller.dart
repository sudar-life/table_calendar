...
class CalendarController {
  ...
  void _selectPreviousMonth() {
    if (_startDay == null) _focusedDay = _previousMonth(_focusedDay);

    if (_startDay != null &&
        _startDay.isBefore(_focusedDay.subtract(Duration(days: 1))))
      _focusedDay = _previousMonth(_focusedDay);
  }

  void _selectNextMonth() {
    if (_endDay == null) _focusedDay = _nextMonth(_focusedDay);

    if (_endDay != null && _endDay.isAfter(_focusedDay.add(Duration(days: 32))))
